...
let eBook1 = new EBook ("Harry Potter and the Philosophers Stone", "J K Rowling", 1997, "EPUB")
let eBook2 = new EBook ("The Fellowship of the Ring", "J R R Tolkien", 1922, "PDF")
